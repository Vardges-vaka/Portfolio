...
const IMAGES = import.meta.glob("../00_assets/images/*.{png,jpg,jpeg,webp,gif,svg,avif}", {
  eager: true,
  query: "?url",
  import: "default",
});
const VIDEOS = import.meta.glob("../00_assets/images/*.{mp4,webm,mov}", {
  eager: true,
  query: "?url",
  import: "default",
});
...
const PDFS = import.meta.glob("../00_assets/pdf/**/*.pdf", {
  eager: true,
  query: "?url",
  import: "default",
});
